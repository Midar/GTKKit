...
static void
clicked_event_handler (GtkWidget *widget,
		       GTKButton *button)
{
...
- (void)encodeWithCoder: (GTKKeyedArchiver *)encoder
{
	...
	case GTKPushButton:
		[encoder encodeString: @"push"
			       forKey: @"GTKKit.coding.button.buttonType"];
		break;
	case GTKToggleButton:
		[encoder encodeString: @"toggle"
			       forKey: @"GTKKit.coding.button.buttonType"];
		break;
	case GTKCheckButton:
		[encoder encodeString: @"check"
			       forKey: @"GTKKit.coding.button.buttonType"];
		break;
	case GTKRadioButton:
		[encoder encodeString: @"radio"
			       forKey: @"GTKKit.coding.button.buttonType"];
		break;
	case GTKSwitchButton:
		[encoder encodeString: @"switch"
			       forKey: @"GTKKit.coding.button.buttonType"];
		break;
	}
	[encoder encodeBool: self.state
		     forKey: @"GTKKit.coding.button.state"];
	[encoder encodeString: self.stringValue
		       forKey: @"GTKKit.coding.button.stringValue"];
}
