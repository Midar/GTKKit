...
static void
changed_handler (GtkComboBox    *widget,
		 GTKPopUpButton *button)
{
...
- (void)encodeWithCoder: (GTKKeyedArchiver *)encoder
{
	...
	[encoder encodeObject: _items
		       forKey: @"GTKKit.coding.popUpButton.popUpItems"];
}
