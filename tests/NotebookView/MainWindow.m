...
- init
{
    ...
    self.notebook = [GTKNotebookView new];
    [self.contentView addSubview: self.notebook];
    [self.notebook.constraints fixedToTop: 10
                                  bottom: 10
                                    left: 10
                                   right: 10];
